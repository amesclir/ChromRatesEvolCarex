...
## load data
mytree <- read.tree("./my_tree65.tree")
mcmcout <- read.csv("./mcmc_out65.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data65.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix65.csv")
