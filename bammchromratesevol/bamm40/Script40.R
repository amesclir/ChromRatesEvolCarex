...
## load data
mytree <- read.tree("./my_tree40.tree")
mcmcout <- read.csv("./mcmc_out40.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data40.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix40.csv")
