...
## load data
mytree <- read.tree("./my_tree60.tree")
mcmcout <- read.csv("./mcmc_out60.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data60.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix60.csv")
