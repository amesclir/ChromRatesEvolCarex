...
## load data
mytree <- read.tree("./my_tree17.tree")
mcmcout <- read.csv("./mcmc_out17.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data17.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix17.csv")
