...
## load data
mytree <- read.tree("./my_tree4.tree")
mcmcout <- read.csv("./mcmc_out4.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data4.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix4.csv")
