...
## load data
mytree <- read.tree("./my_tree57.tree")
mcmcout <- read.csv("./mcmc_out57.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data57.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix57.csv")
