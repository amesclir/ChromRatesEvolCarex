...
## load data
mytree <- read.tree("./my_tree12.tree")
mcmcout <- read.csv("./mcmc_out12.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data12.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix12.csv")
