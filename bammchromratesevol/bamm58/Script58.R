...
## load data
mytree <- read.tree("./my_tree58.tree")
mcmcout <- read.csv("./mcmc_out58.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data58.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix58.csv")
