...
## load data
mytree <- read.tree("./my_tree52.tree")
mcmcout <- read.csv("./mcmc_out52.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data52.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix52.csv")
