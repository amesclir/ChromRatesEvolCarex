...
## load data
mytree <- read.tree("./my_tree16.tree")
mcmcout <- read.csv("./mcmc_out16.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data16.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix16.csv")
