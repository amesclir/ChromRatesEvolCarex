...
## load data
mytree <- read.tree("./my_tree69.tree")
mcmcout <- read.csv("./mcmc_out69.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data69.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix69.csv")
