...
## load data
mytree <- read.tree("./my_tree8.tree")
mcmcout <- read.csv("./mcmc_out8.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data8.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix8.csv")
