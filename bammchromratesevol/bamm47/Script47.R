...
## load data
mytree <- read.tree("./my_tree47.tree")
mcmcout <- read.csv("./mcmc_out47.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data47.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix47.csv")
