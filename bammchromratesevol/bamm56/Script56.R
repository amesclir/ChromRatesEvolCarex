...
## load data
mytree <- read.tree("./my_tree56.tree")
mcmcout <- read.csv("./mcmc_out56.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data56.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix56.csv")
