...
## load data
mytree <- read.tree("./my_tree53.tree")
mcmcout <- read.csv("./mcmc_out53.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data53.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix53.csv")
