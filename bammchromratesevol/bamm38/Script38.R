...
## load data
mytree <- read.tree("./my_tree38.tree")
mcmcout <- read.csv("./mcmc_out38.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data38.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix38.csv")
