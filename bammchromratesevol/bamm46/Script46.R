...
## load data
mytree <- read.tree("./my_tree46.tree")
mcmcout <- read.csv("./mcmc_out46.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data46.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix46.csv")
