...
## load data
mytree <- read.tree("./my_tree51.tree")
mcmcout <- read.csv("./mcmc_out51.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data51.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix51.csv")
