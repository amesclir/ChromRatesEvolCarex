...
## load data
mytree <- read.tree("./my_tree25.tree")
mcmcout <- read.csv("./mcmc_out25.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data25.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix25.csv")
