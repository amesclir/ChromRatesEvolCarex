...
## load data
mytree <- read.tree("./my_tree26.tree")
mcmcout <- read.csv("./mcmc_out26.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data26.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix26.csv")
