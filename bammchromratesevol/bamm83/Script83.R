...
## load data
mytree <- read.tree("./my_tree83.tree")
mcmcout <- read.csv("./mcmc_out83.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data83.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix83.csv")
