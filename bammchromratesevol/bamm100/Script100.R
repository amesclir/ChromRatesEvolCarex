...
## load data
mytree <- read.tree("./my_tree100.tree")
mcmcout <- read.csv("./mcmc_out100.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data100.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix100.csv")
