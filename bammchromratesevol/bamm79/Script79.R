...
## load data
mytree <- read.tree("./my_tree79.tree")
mcmcout <- read.csv("./mcmc_out79.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data79.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix79.csv")
