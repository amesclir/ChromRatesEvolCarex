...
## load data
mytree <- read.tree("./my_tree9.tree")
mcmcout <- read.csv("./mcmc_out9.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data9.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix9.csv")
