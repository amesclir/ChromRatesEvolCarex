...
## load data
mytree <- read.tree("./my_tree31.tree")
mcmcout <- read.csv("./mcmc_out31.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data31.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix31.csv")
