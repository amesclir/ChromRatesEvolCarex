...
## load data
mytree <- read.tree("./my_tree78.tree")
mcmcout <- read.csv("./mcmc_out78.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data78.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix78.csv")
