...
## load data
mytree <- read.tree("./my_tree61.tree")
mcmcout <- read.csv("./mcmc_out61.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data61.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix61.csv")
