...
## load data
mytree <- read.tree("./my_tree6.tree")
mcmcout <- read.csv("./mcmc_out6.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data6.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix6.csv")
