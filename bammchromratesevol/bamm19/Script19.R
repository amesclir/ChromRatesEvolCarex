...
## load data
mytree <- read.tree("./my_tree19.tree")
mcmcout <- read.csv("./mcmc_out19.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data19.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix19.csv")
