...
## load data
mytree <- read.tree("./my_tree95.tree")
mcmcout <- read.csv("./mcmc_out95.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data95.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix95.csv")
