...
## load data
mytree <- read.tree("./my_tree73.tree")
mcmcout <- read.csv("./mcmc_out73.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data73.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix73.csv")
