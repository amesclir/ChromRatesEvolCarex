...
## load data
mytree <- read.tree("./my_tree68.tree")
mcmcout <- read.csv("./mcmc_out68.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data68.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix68.csv")
