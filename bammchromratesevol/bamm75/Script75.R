...
## load data
mytree <- read.tree("./my_tree75.tree")
mcmcout <- read.csv("./mcmc_out75.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data75.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix75.csv")
