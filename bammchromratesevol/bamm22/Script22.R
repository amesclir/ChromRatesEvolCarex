...
## load data
mytree <- read.tree("./my_tree22.tree")
mcmcout <- read.csv("./mcmc_out22.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data22.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix22.csv")
