...
## load data
mytree <- read.tree("./my_tree71.tree")
mcmcout <- read.csv("./mcmc_out71.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data71.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix71.csv")
