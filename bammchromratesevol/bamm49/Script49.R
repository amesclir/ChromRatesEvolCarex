...
## load data
mytree <- read.tree("./my_tree49.tree")
mcmcout <- read.csv("./mcmc_out49.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data49.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix49.csv")
