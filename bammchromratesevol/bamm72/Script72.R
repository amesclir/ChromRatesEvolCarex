...
## load data
mytree <- read.tree("./my_tree72.tree")
mcmcout <- read.csv("./mcmc_out72.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data72.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix72.csv")
