...
## load data
mytree <- read.tree("./my_tree10.tree")
mcmcout <- read.csv("./mcmc_out10.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data10.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix10.csv")
