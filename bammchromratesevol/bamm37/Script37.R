...
## load data
mytree <- read.tree("./my_tree37.tree")
mcmcout <- read.csv("./mcmc_out37.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data37.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix37.csv")
