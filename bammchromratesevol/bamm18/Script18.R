...
## load data
mytree <- read.tree("./my_tree18.tree")
mcmcout <- read.csv("./mcmc_out18.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data18.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix18.csv")
