...
## load data
mytree <- read.tree("./my_tree32.tree")
mcmcout <- read.csv("./mcmc_out32.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data32.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix32.csv")
