...
## load data
mytree <- read.tree("./my_tree36.tree")
mcmcout <- read.csv("./mcmc_out36.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data36.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix36.csv")
