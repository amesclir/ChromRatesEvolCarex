...
## load data
mytree <- read.tree("./my_tree41.tree")
mcmcout <- read.csv("./mcmc_out41.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data41.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix41.csv")
