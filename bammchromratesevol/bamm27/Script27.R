...
## load data
mytree <- read.tree("./my_tree27.tree")
mcmcout <- read.csv("./mcmc_out27.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data27.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix27.csv")
