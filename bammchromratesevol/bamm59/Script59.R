...
## load data
mytree <- read.tree("./my_tree59.tree")
mcmcout <- read.csv("./mcmc_out59.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data59.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix59.csv")
