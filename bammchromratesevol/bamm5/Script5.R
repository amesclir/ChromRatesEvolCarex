...
## load data
mytree <- read.tree("./my_tree5.tree")
mcmcout <- read.csv("./mcmc_out5.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data5.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix5.csv")
