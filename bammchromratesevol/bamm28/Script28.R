...
## load data
mytree <- read.tree("./my_tree28.tree")
mcmcout <- read.csv("./mcmc_out28.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data28.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix28.csv")
