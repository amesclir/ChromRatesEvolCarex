...
## load data
mytree <- read.tree("./my_tree55.tree")
mcmcout <- read.csv("./mcmc_out55.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data55.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix55.csv")
