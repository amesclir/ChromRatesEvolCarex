...
## load data
mytree <- read.tree("./my_tree76.tree")
mcmcout <- read.csv("./mcmc_out76.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data76.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix76.csv")
