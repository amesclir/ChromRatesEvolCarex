...
## load data
mytree <- read.tree("./my_tree91.tree")
mcmcout <- read.csv("./mcmc_out91.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data91.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix91.csv")
