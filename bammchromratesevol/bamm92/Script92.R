...
## load data
mytree <- read.tree("./my_tree92.tree")
mcmcout <- read.csv("./mcmc_out92.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data92.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix92.csv")
