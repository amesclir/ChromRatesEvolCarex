...
## load data
mytree <- read.tree("./my_tree30.tree")
mcmcout <- read.csv("./mcmc_out30.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data30.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix30.csv")
