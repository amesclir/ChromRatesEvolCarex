...
## load data
mytree <- read.tree("./my_tree35.tree")
mcmcout <- read.csv("./mcmc_out35.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data35.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix35.csv")
