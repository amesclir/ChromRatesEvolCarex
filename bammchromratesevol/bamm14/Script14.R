...
## load data
mytree <- read.tree("./my_tree14.tree")
mcmcout <- read.csv("./mcmc_out14.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data14.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix14.csv")
