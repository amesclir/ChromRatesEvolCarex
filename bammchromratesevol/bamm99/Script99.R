...
## load data
mytree <- read.tree("./my_tree99.tree")
mcmcout <- read.csv("./mcmc_out99.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data99.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix99.csv")
