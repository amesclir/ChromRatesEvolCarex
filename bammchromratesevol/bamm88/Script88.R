...
## load data
mytree <- read.tree("./my_tree88.tree")
mcmcout <- read.csv("./mcmc_out88.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data88.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix88.csv")
