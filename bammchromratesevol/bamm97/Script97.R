...
## load data
mytree <- read.tree("./my_tree97.tree")
mcmcout <- read.csv("./mcmc_out97.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data97.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix97.csv")
