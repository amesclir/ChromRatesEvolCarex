...
## load data
mytree <- read.tree("./my_tree34.tree")
mcmcout <- read.csv("./mcmc_out34.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data34.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix34.csv")
