...
## load data
mytree <- read.tree("./my_tree85.tree")
mcmcout <- read.csv("./mcmc_out85.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data85.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix85.csv")
