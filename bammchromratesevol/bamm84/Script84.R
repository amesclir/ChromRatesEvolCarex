...
## load data
mytree <- read.tree("./my_tree84.tree")
mcmcout <- read.csv("./mcmc_out84.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data84.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix84.csv")
