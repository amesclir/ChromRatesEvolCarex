...
## load data
mytree <- read.tree("./my_tree81.tree")
mcmcout <- read.csv("./mcmc_out81.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data81.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix81.csv")
