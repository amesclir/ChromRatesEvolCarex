...
## load data
mytree <- read.tree("./my_tree44.tree")
mcmcout <- read.csv("./mcmc_out44.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data44.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix44.csv")
