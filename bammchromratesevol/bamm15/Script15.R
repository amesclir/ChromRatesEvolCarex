...
## load data
mytree <- read.tree("./my_tree15.tree")
mcmcout <- read.csv("./mcmc_out15.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data15.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix15.csv")
