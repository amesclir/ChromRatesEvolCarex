...
## load data
mytree <- read.tree("./my_tree1.tree")
mcmcout <- read.csv("./mcmc_out1.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data1.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix1.csv")
