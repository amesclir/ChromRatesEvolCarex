...
## load data
mytree <- read.tree("./my_tree96.tree")
mcmcout <- read.csv("./mcmc_out96.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data96.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix96.csv")
