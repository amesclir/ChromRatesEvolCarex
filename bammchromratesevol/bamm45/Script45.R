...
## load data
mytree <- read.tree("./my_tree45.tree")
mcmcout <- read.csv("./mcmc_out45.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data45.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix45.csv")
