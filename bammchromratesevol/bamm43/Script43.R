...
## load data
mytree <- read.tree("./my_tree43.tree")
mcmcout <- read.csv("./mcmc_out43.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data43.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix43.csv")
