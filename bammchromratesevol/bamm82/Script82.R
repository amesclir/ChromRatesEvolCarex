...
## load data
mytree <- read.tree("./my_tree82.tree")
mcmcout <- read.csv("./mcmc_out82.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data82.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix82.csv")
