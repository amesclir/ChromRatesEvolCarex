...
## load data
mytree <- read.tree("./my_tree80.tree")
mcmcout <- read.csv("./mcmc_out80.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data80.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix80.csv")
