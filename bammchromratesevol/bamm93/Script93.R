...
## load data
mytree <- read.tree("./my_tree93.tree")
mcmcout <- read.csv("./mcmc_out93.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data93.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix93.csv")
