...
## load data
mytree <- read.tree("./my_tree11.tree")
mcmcout <- read.csv("./mcmc_out11.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data11.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix11.csv")
