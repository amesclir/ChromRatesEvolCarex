...
## load data
mytree <- read.tree("./my_tree66.tree")
mcmcout <- read.csv("./mcmc_out66.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data66.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix66.csv")
