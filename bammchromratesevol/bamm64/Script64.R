...
## load data
mytree <- read.tree("./my_tree64.tree")
mcmcout <- read.csv("./mcmc_out64.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data64.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix64.csv")
