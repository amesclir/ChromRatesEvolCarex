...
## load data
mytree <- read.tree("./my_tree39.tree")
mcmcout <- read.csv("./mcmc_out39.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data39.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix39.csv")
