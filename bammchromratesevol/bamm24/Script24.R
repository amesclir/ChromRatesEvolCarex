...
## load data
mytree <- read.tree("./my_tree24.tree")
mcmcout <- read.csv("./mcmc_out24.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data24.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix24.csv")
