...
## load data
mytree <- read.tree("./my_tree13.tree")
mcmcout <- read.csv("./mcmc_out13.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data13.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix13.csv")
