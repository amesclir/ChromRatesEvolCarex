...
## load data
mytree <- read.tree("./my_tree90.tree")
mcmcout <- read.csv("./mcmc_out90.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data90.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix90.csv")
