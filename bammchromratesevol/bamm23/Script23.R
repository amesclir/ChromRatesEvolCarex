...
## load data
mytree <- read.tree("./my_tree23.tree")
mcmcout <- read.csv("./mcmc_out23.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data23.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix23.csv")
