...
## load data
mytree <- read.tree("./my_tree86.tree")
mcmcout <- read.csv("./mcmc_out86.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data86.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix86.csv")
