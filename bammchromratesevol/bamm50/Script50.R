...
## load data
mytree <- read.tree("./my_tree50.tree")
mcmcout <- read.csv("./mcmc_out50.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data50.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix50.csv")
