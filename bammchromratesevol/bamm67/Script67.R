...
## load data
mytree <- read.tree("./my_tree67.tree")
mcmcout <- read.csv("./mcmc_out67.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data67.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix67.csv")
