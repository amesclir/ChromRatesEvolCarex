...
## load data
mytree <- read.tree("./my_tree63.tree")
mcmcout <- read.csv("./mcmc_out63.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data63.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix63.csv")
