...
## load data
mytree <- read.tree("./my_tree54.tree")
mcmcout <- read.csv("./mcmc_out54.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data54.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix54.csv")
