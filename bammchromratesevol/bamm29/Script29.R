...
## load data
mytree <- read.tree("./my_tree29.tree")
mcmcout <- read.csv("./mcmc_out29.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data29.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix29.csv")
