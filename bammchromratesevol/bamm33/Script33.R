...
## load data
mytree <- read.tree("./my_tree33.tree")
mcmcout <- read.csv("./mcmc_out33.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data33.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix33.csv")
