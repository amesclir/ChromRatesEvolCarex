...
## load data
mytree <- read.tree("./my_tree74.tree")
mcmcout <- read.csv("./mcmc_out74.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data74.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix74.csv")
