...
## load data
mytree <- read.tree("./my_tree77.tree")
mcmcout <- read.csv("./mcmc_out77.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data77.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix77.csv")
