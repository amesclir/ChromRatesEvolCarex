...
## load data
mytree <- read.tree("./my_tree2.tree")
mcmcout <- read.csv("./mcmc_out2.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data2.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix2.csv")
