...
## load data
mytree <- read.tree("./my_tree94.tree")
mcmcout <- read.csv("./mcmc_out94.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data94.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix94.csv")
