...
## load data
mytree <- read.tree("./my_tree3.tree")
mcmcout <- read.csv("./mcmc_out3.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data3.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix3.csv")
