...
## load data
mytree <- read.tree("./my_tree42.tree")
mcmcout <- read.csv("./mcmc_out42.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data42.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix42.csv")
