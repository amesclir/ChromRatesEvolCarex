...
## load data
mytree <- read.tree("./my_tree48.tree")
mcmcout <- read.csv("./mcmc_out48.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data48.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix48.csv")
