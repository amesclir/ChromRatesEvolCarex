...
## load data
mytree <- read.tree("./my_tree7.tree")
mcmcout <- read.csv("./mcmc_out7.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data7.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix7.csv")
