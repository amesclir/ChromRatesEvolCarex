...
## load data
mytree <- read.tree("./my_tree70.tree")
mcmcout <- read.csv("./mcmc_out70.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data70.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix70.csv")
