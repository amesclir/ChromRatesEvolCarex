...
## load data
mytree <- read.tree("./my_tree89.tree")
mcmcout <- read.csv("./mcmc_out89.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data89.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix89.csv")
