...
## load data
mytree <- read.tree("./my_tree98.tree")
mcmcout <- read.csv("./mcmc_out98.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data98.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix98.csv")
