...
## load data
mytree <- read.tree("./my_tree20.tree")
mcmcout <- read.csv("./mcmc_out20.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data20.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix20.csv")
