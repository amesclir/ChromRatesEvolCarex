...
## load data
mytree <- read.tree("./my_tree87.tree")
mcmcout <- read.csv("./mcmc_out87.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data87.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix87.csv")
