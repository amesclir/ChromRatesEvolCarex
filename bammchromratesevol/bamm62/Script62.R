...
## load data
mytree <- read.tree("./my_tree62.tree")
mcmcout <- read.csv("./mcmc_out62.txt")

## create edata
edata <- getEventData(mytree, eventdata = "./event_data62.txt", burnin=0.15, type = "trait")
...
branch_matrix
write.csv(branch_matrix, file = "branch_matrix62.csv")
